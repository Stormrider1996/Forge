<x-app-layout>
    ...
    <body class="bg-gray-100">
        <form action="{{ route('top-headlines') }}" class="mt-8">
        ...
        <div class="flex justify-center mt-8">
            <div class="inline-flex rounded-md shadow">
                <div class="flex justify-center space-x-2">
                    ...
                    @for ($i = $startPage; $i <= $endPage; $i++) <a href="?page={{ $i }}{{ $q ? '&q=' . $q : '' }}"
                        ...
                        @if ($currentPage < $totalPages - 1) @if ($currentPage < $totalPages - 2) <span
                            class="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300">...</span>
                            @endif
