...
class NewsController extends Controller
{
    ...
    public function indexAllNews(Request $request, PaginationService $pagination): View
    {
        ...
        return view('all-headlines', compact('_articles',  'params', 'totalPages', 'pagination_links'));
    }
    ...
    public function indexTopHeadlines(Request $request): View
    {
        ...
        $topHeadlines = News::paginatedListTopHeadlines(
            $request->q,
            $request->source,
            $request->user()->country ?? 'us',
            $request->category,
            $request->page_size,
            $request->page
        );

        return view('top-headlines', compact('topHeadlines', 'params'));
    }
    ...
    public function indexSources(Request $request, News $allHeadlines): View
    {
        ...
        return view('sources', compact('sources', 'language'));
    }
}
